package dev.andrylat.kedat.config.websocket;

import dev.andrylat.kedat.devicesession.websocket.DeviceSessionHandler;
import dev.andrylat.kedat.gamesession.websocket.GameSessionHandler;
import dev.andrylat.kedat.metric.websocket.DeviceMetricHandler;
